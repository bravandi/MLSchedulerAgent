...
data dataset;                                                                                                                              
   ...
   datalines;                                                                                                                           
1	6.0	12.0	12.0	12.0

2	35.0	43.0	50.0	43.0

3	40.0	61.0	47.0	47.0
...
axis2 label=("J48 IOPS SLO Violation Percentage")
      order=(0 to 66 by 5) minor=(n=1);

proc gplot data=dataset;
   	plot policy*(SequentialRead SequentialWrite RWRead RWWrite) / overlay legend=legend1                                                                               
